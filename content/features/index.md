...
- [3.2 Update](#32-update)
  ...
  - [Campaign Mechanics](#campaign-mechanics)
    ...
    - [Cinematic Intros and Faction Movies](#cinematic-intros-and-faction-movies)
    ...
    - [New Building Effects](#new-building-effects)
  ...
  - [Animations](#animations)
    - [Bowstring Animations](#bowstring-animations)
    - [New Death Animations](#new-death-animations)
    - [Faster Diplomat Animations](#faster-diplomat-animations)
  - [Sounds](#sounds-1)
...
- [Faction Changes](#faction-changes)
    ...
    - [Northern Dunedain](#northern-dunedain-1)
...
{{< gallery match="images/disasters/*" >}}
...
### Last Stand Armies
AI factions get a helping stack of elite units once they go down a certain threshold of held regions depending on their starting domain size. In V3, these are dynamically scripted to contain regional units depending on which regions the faction still holds as well as certain units based on what events have occured (i.e good Khand and evil Khand get different units, Dorwinion gets Avari units if they have good relations etc.). Last stand armies now also appear at the faction's capital city instead of in a static location like before.
...
{{< gallery match="images/historicEvents/*" >}}
...
{{< gallery match="images/unitPrefixes/*" >}}
...
{{< gallery match="images/settlementRebuilding/*" >}}
...
{{< gallery match="images/rebelFactions/*" >}}
...
{{< gallery match="images/revealSetts/*" >}}
...
{{< gallery match="images/garrisonScript/*" >}}
...
{{< gallery match="images/factionRevival/*" >}}
...
{{< gallery match="images/tradeResources/*" >}}
...
{{< gallery match="images/genericModels/*" >}}
...
{{< gallery match="images/characterStratModels/*" >}}
...
{{< gallery match="images/settlementStrategyModels/*" >}}
...
{{< gallery match="images/hideArmyInfo/*" >}}
...
{{< gallery match="images/autoTraitDesc/*" >}}
...
{{< gallery match="images/newTraits/*" >}}
...
{{< gallery match="images/stackSorting/*" >}}
...
{{< gallery match="images/minorSettlements/*" >}}
...
{{< gallery match="images/landmarkBuildings/*" >}}
...
{{< gallery match="images/welcomeScreen/*" >}}
...
{{< gallery match="images/customColours/*" >}}
...
{{< gallery match="images/buildingUI/*" >}}
...
{{< gallery match="images/unitCards/*" >}}
...
{{< gallery match="images/portraits/*" >}}
...
{{< gallery match="images/loadingScreens/*" >}}
